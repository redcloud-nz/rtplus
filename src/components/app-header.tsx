...
import { BadgeCheckIcon, BellIcon, CircleUserIcon, KeyRoundIcon, LogInIcon, LogOutIcon, PanelLeft, ShieldQuestionIcon } from 'lucide-react'
...
export function AppHeader() {
    ...
    return <header className="row-start-1 col-start-1 px-1 py-2 flex justify-between items-center">
