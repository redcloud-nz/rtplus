...
export const button2Variants = tv({
...
export function Button2({ className, variant, size, asChild = false, ...props }: ComponentProps<"button"> & VariantProps<typeof button2Variants> & { asChild?: boolean }) {
