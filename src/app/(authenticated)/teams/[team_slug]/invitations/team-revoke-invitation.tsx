...
export function Team_RevokeInvitation_Dialog({ orgInvitation, ...props }: ComponentProps<typeof Dialog> & { orgInvitation: TeamInvitationData }) {
    ...
    return <Dialog {...props}>
        <DialogContent>
            ...
            <DialogBody>
                <Team_RevokeInvitation_Form orgInvitation={orgInvitation} onClose={() => props.onOpenChange?.(false)} />
            </DialogBody>
        </DialogContent>
    </Dialog>
}

function Team_RevokeInvitation_Form({ orgInvitation, onClose }: { orgInvitation: TeamInvitationData, onClose: () => void }) {
