...
export default async function AdminModule_Index_Page() {
    ...
    return <AppPage>
            ...
            <AppPageContent variant="container">
                    ...
                    <DashboardCardList>
                        <DashboardCard
                            linksTo={Paths.adminModule.personnel}
                        ...
                        />
                         <DashboardCard
                            linksTo={Paths.adminModule.settings}
                        ...
                        <ModuleOnly module="skills">
                            <DashboardCard
                                linksTo={Paths.adminModule.skillPackages}
                        ...
                        <DashboardCard
                            linksTo={Paths.adminModule.teams}
