 ...
 * 
 *  Path: /org/[org_slug]/admin/skill-packages/[skill_package_id]/groups/[skill_group_id]
 */
...
export async function generateMetadata(props: PageProps<'/orgs/[org_slug]/admin/skill-packages/[skill_package_id]/groups/[skill_group_id]'>) {
...
export default async function AdminModule_SkillGroup_Page(props: PageProps<'/orgs/[org_slug]/admin/skill-packages/[skill_package_id]/groups/[skill_group_id]'>) {
    const { org_slug: orgSlug, skill_package_id: skillPackageId, skill_group_id: skillGroupId } = await props.params
   const organization = await getOrganization(orgSlug)
    const skillGroup = await fetchSkillGroup({ orgId: organization.orgId, skillGroupId, skillPackageId })
    ...
    return <AppPage>
        <AppPageBreadcrumbs
            breadcrumbs={[
                ...
                { label: skillGroup.skillPackage.name, href: Paths.org(orgSlug).admin.skillPackage(skillPackageId).href },
