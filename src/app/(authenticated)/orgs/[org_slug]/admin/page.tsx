...
export default async function AdminModule_Index_Page(props: PageProps<'/orgs/[org_slug]/admin'>) {
    ...
    return <AppPage>
        ...
        <AppPageContent variant="container">
            ...
            <DashboardCardList>
                <DashboardCard
                    linksTo={Paths.org(orgSlug).admin.personnel}
                ...
                />
                    <DashboardCard
                    linksTo={Paths.org(orgSlug).admin.settings}
                ...
                <ModuleOnly module="skills">
                    <DashboardCard
                        linksTo={Paths.org(orgSlug).admin.skillPackages}
                ...
                <DashboardCard
                    linksTo={Paths.org(orgSlug).admin.teams}
