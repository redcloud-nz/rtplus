 ...
 * 
 *  Path: /orgs/[org_slug]/skills/reports/team-skills
 */
...
export default async function Team_Skills_Report_Page(props: PageProps<'/orgs/[org_slug]/skills/reports/team-skills'>) {
    ...
    >
        <AppPageBreadcrumbs
            breadcrumbs={[
                ...
                Paths.org(orgSlug).skills.reports.teamSkills
            ]}
        />
