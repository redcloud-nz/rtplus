...
export async function generateMetadata(props: PageProps<'/orgs/[org_slug]/skill-package-manager/skill-packages/[skill_package_id]/skills/[skill_id]'>) {
...
export default async function AdminModule_Skill_Page(props: PageProps<'/orgs/[org_slug]/skill-package-manager/skill-packages/[skill_package_id]/skills/[skill_id]'>) {
    const { org_slug: orgSlug, skill_package_id: skillPackageId, skill_id: skillId } = await props.params
    const organization = await getOrganization(orgSlug)
    const skill = await fetchSkill({ orgId: organization.orgId, skillId, skillPackageId })
