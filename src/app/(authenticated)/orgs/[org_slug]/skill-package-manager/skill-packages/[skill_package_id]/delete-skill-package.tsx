...
export function AdminModule_DeleteSkillPackage_Dialog({ organization, skillPackage, ...props }: Omit<ComponentProps<typeof Dialog>, 'children'> & { organization: OrganizationData, skillPackage: SkillPackageData }) {
