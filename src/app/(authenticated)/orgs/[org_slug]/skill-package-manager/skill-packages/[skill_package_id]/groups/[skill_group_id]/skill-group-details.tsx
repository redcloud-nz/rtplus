                ...
                .with('View', () => 
                    <ToruGrid>
                        ...
                        <ToruGridRow
                            ...
                            control={
                                <DisplayValue>
                                    <TextLink to={Paths.org(organization.slug).skillPackageManager.skillPackage(skillGroup.skillPackageId)}>
            ...
            <ToruGrid mode="form">
                ...
                <FormField
                    ...
                    render={() => <ToruGridRow
                        ...
                        control={
                            <DisplayValue>
                                <TextLink to={Paths.org(organization.slug).skillPackageManager.skillPackage(skillPackage.skillPackageId)}>
                                    {skillPackage.name}
                                </TextLink>
                            </DisplayValue>
                        }
...
function DeleteSkillGroupDialog({ organization, skillGroup }: { organization: OrganizationData, skillGroup: SkillGroupData }) {
    ...
    const mutation = useMutation(trpc.skills.deleteGroup.mutationOptions({
        ...
        onSuccess(result) {
            ...
            router.push(Paths.org(organization.slug).skillPackageManager.skillPackage(skillGroup.skillPackageId).group(skillGroup.skillGroupId).href)
        }
    }))
