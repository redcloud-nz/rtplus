...
export default async function Team_Skills_Index_Page(props: { params: Promise<{ team_slug: string }> }) {
    ...
    return <AppPage>
        ...
        <AppPageContent variant="container">
            ...
            <Paragraph>
                Welcome to the RT+ skills module. If you are a team admin, you can <TextLink to={Paths.org(team).skills.sessions.create}/> a session or start recording skill checks.
