...
export default function DeleteTeamMemberSheet(props: { params: Promise<{ person_id: string, team_id: string }> }) {
    ...
    return <Sheet open={true} onOpenChange={open => { if(!open) router.back() }}>
        <SheetContent>
            <SheetHeader>
                <SheetTitle>Remove Team Member</SheetTitle>
                <SheetDescription>Remove a person from this team.</SheetDescription>
            </SheetHeader>
            <SheetBody>
